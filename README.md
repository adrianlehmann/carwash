# Crystal Clean Car Wash Website

Marketing site for Crystal Clean Car Wash, built with React and Vite.
...
This repo is set up for a **static** Cloudflare Pages deploy of the site in `artifacts/crystal-clean`.
...
| **Build output directory** | `artifacts/crystal-clean/dist/public` |
...
| Path | Purpose |
|------|---------|
| `artifacts/crystal-clean` | **Production static site** (deploy this) |
